    ...
    <div class="col-12 grid-margin">
        <div class="card">
            <div class="card-body">
                ...
                <form class="form-sample" id="doctor" method="post" action="{{ route('admin.d.storeDoctorInfo') }}">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" value="{{old('fname')}}" required name="fname" class="form-control {{ $errors->has('fname') ? 'is-invalid' : '' }}">
                                    @if ($errors->has('fname'))
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" value="{{old('mname')}}" name="mname" class="form-control {{ $errors->has('mname') ? 'is-invalid' : '' }}">
                                    @if ($errors->has('mname'))
                                    <span class="invalid feedback" role="alert">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" value="{{old('lname')}}" name="lname" class="form-control {{ $errors->has('lname') ? 'is-invalid' : '' }}">
                                    @if ($errors->has('lname'))
                                    <span class="invalid feedback" role="alert">
                                ...
                                <div class="col-sm-9">
                                    <select name="departments" class="form-control {{ $errors->has('departments') ? 'is-invalid' : '' }}" id="departments">
                                        ...
                                        @foreach ($departments as $department)
                                            <option value="{{ $department->id }}" @if(old('departments') == $department->id) selected @endif> {{ $department->department_name }}</option>
                                        @endforeach
                                    </select>
